...
def stream_generate_dd_answer_test(
    client: openai.ChatCompletion, background: str, dd_prompt
):
...
def send_xlsx_content_to_openai(
    file_path: str, client: openai.ChatCompletion
) -> list[str]:
